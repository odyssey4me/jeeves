...
- **jenkins_username**: Your Jenkins username (optional)
- **jenkins_api_token**: Your Jenkins API token (optional)
...
- **email_from**: The email address of the sender. This is read from the jenkins user if it is not provided.
